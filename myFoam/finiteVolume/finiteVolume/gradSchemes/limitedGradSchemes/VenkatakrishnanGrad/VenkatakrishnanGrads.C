...
Foam::fv::VenkatakrishnanGrad<Foam::scalar>::calcGrad
(
...
) const
{
    ...
    const scalarField& cellVolume = mesh.V();
...
Foam::fv::VenkatakrishnanGrad<Foam::vector>::calcGrad
(
